...
class SequenceAlignment():
    ...
    Attributes:
        ...
        seq3 (Sequence, optional): A terceira sequência a ser alinhada.
        ...
        aligned_seq3 (str, optional): A terceira sequência após o alinhamento.
        score (int): É o tamanho do lcs.
    """
    ...
    def identity(self) -> float:
        """
        Calcula a identidade do alinhamento.
